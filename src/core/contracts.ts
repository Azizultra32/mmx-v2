...
export const ARTIFACT_CONTRACTS: ArtifactContract[] = [
  // ── Cathedral ──────────────────────────────────────────────────────────────
  {
    ...
    pathPattern: '.mmx/runs/{run_id}/cathedral/brief.md',
    format: 'markdown',
    cardinality: 'one',
    branchScoped: false,
    canonical: true,
  ...
  },
  {
    ...
    stage: 'cathedral',
    ownerRole: 'cathedral-agent',
    pathPattern: '.mmx/runs/{run_id}/cathedral/schematics/index.json',
    format: 'json',
    cardinality: 'one',
    branchScoped: false,
    canonical: true,
  ...
  },
  {
    ...
    stage: 'cathedral',
    ownerRole: 'cathedral-agent',
    pathPattern: '.mmx/runs/{run_id}/cathedral/briefings/{batch_id}.json',
    format: 'json',
    cardinality: 'many',
    branchScoped: false,
    canonical: false,
  ...
  // ── Find ───────────────────────────────────────────────────────────────────
  {
    ...
    pathPattern: '.mmx/runs/{run_id}/find/raw/{fid8}.json',
    format: 'json',
    cardinality: 'many',
    branchScoped: false,
    canonical: false,
  ...
  },
  {
    ...
    stage: 'find',
    ownerRole: 'find-agent',
    pathPattern: '.mmx/runs/{run_id}/find/merged/{fid8}.json',
    format: 'json',
    cardinality: 'many',
    branchScoped: false,
    canonical: true,
  ...
  },
  {
    ...
    stage: 'find',
    ownerRole: 'find-agent',
    pathPattern: '.mmx/runs/{run_id}/find/convergence/{fid8}.json',
    format: 'json',
    cardinality: 'many',
    branchScoped: false,
    canonical: true,
  ...
  },
  {
    ...
    stage: 'find',
    ownerRole: 'find-agent',
    pathPattern: '.mmx/runs/{run_id}/find/convergence/convergence-matrix.json',
    format: 'json',
    cardinality: 'one',
    branchScoped: false,
    canonical: true,
  ...
  // ── Distill ────────────────────────────────────────────────────────────────
  {
    ...
    pathPattern: '.mmx/runs/{run_id}/distill/verdicts/{fid8}.json',
    format: 'json',
    cardinality: 'many',
    branchScoped: false,
    canonical: true,
  ...
  },
  {
    ...
    stage: 'distill',
    ownerRole: 'distill-challenger',
    pathPattern: '.mmx/runs/{run_id}/distill/challenges/{fid8}.md',
    format: 'markdown',
    cardinality: 'many',
    branchScoped: false,
    canonical: false,
  ...
  },
  {
    ...
    stage: 'distill',
    ownerRole: 'distill-challenger',
    pathPattern: '.mmx/runs/{run_id}/distill/approved/{fid8}.packet.json',
    format: 'json',
    cardinality: 'many',
    branchScoped: false,
    canonical: true,
  ...
  // ── Predict ────────────────────────────────────────────────────────────────
  {
    ...
    pathPattern: '.mmx/runs/{run_id}/predict/{subrole}/{fid8}.json',
    format: 'json',
    cardinality: 'many',
    branchScoped: false,
    canonical: false,
  ...
  },
  {
    ...
    stage: 'predict',
    ownerRole: 'predict-da',
    pathPattern: '.mmx/runs/{run_id}/predict/approved/{fid8}.packet.json',
    format: 'json',
    cardinality: 'many',
    branchScoped: false,
    canonical: true,
  ...
  // ── Propose ────────────────────────────────────────────────────────────────
  {
    ...
    pathPattern: '.mmx/runs/{run_id}/propose/proposals/{fid8}.{branch}.json',
    format: 'json',
    cardinality: 'many',
    branchScoped: true,
    canonical: false,
  ...
  },
  {
    ...
    stage: 'propose',
    ownerRole: 'propose-architect',
    pathPattern: '.mmx/runs/{run_id}/propose/approved/{fid8}.{branch}.packet.json',
    format: 'json',
    cardinality: 'many',
    branchScoped: true,
    canonical: true,
  ...
  // ── Implement ──────────────────────────────────────────────────────────────
  {
    ...
    pathPattern: '.mmx/runs/{run_id}/implement/patches/{fid8}.{cycle}.diff',
    format: 'diff',
    cardinality: 'many',
    branchScoped: false,
    canonical: false,
  ...
  },
  {
    ...
    stage: 'implement',
    ownerRole: 'implement-holistic',
    pathPattern: '.mmx/runs/{run_id}/implement/approved/{fid8}.packet.json',
    format: 'json',
    cardinality: 'many',
    branchScoped: false,
    canonical: true,
  ...
  },
  {
    ...
    stage: 'implement',
    ownerRole: 'implement-holistic',
    pathPattern: '.mmx/runs/{run_id}/implement/ifr/{fid8}.{cycle}.json',
    format: 'json',
    cardinality: 'many',
    branchScoped: false,
    canonical: false,
  ...
  // ── FinalGuard ─────────────────────────────────────────────────────────────
  {
    ...
    pathPattern: '.mmx/runs/{run_id}/finalguard/verdicts/{fid8}.json',
    format: 'json',
    cardinality: 'many',
    branchScoped: false,
    canonical: true,
  ...
  },
  {
    ...
    stage: 'finalguard',
    ownerRole: 'finalguard-agent',
    pathPattern: '.mmx/runs/{run_id}/finalguard/receipt/{fid8}.html',
    format: 'html',
    cardinality: 'many',
    branchScoped: false,
    canonical: false,
  ...
  // ── HumanGate ──────────────────────────────────────────────────────────────
  {
    ...
    pathPattern: '.mmx/runs/{run_id}/human/packets/{fid8}.packet.json',
    format: 'json',
    cardinality: 'many',
    branchScoped: false,
    canonical: true,
  ...
  },
  {
    ...
    stage: 'humangate',
    ownerRole: 'humangate-agent',
    pathPattern: '.mmx/runs/{run_id}/human/decisions/{fid8}.json',
    format: 'json',
    cardinality: 'many',
    branchScoped: false,
    canonical: true,
